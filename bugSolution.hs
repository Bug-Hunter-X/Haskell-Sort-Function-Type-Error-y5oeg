...
main = do
  ...
  -- Handling mixed types using sortWith and comparing
  let mixed = [1, "apple", 3, "banana", 2]
  let sortedMixed = sortWith comparing mixed
  print sortedMixed -- this will print [1,2,3,"apple","banana"]
```